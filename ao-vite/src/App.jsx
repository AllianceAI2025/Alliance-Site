...
// Both pages (/, /security/) load the same webfonts once.
    ...
    <section style={{ position: "relative", overflow: "hidden", padding: "clamp(4rem,8vw,7rem) 0 clamp(4rem,7vw,6rem)" }}>
      ...
      <Wrap style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginTop: "2.4rem", display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <Btn variant="ghost" href="/#how-it-works" onClick={(e) => { const el = document.getElementById("how-it-works"); if (el) { e.preventDefault(); el.scrollIntoView({ behavior: "smooth" }); } }}>See how it works</Btn>
        </div>
      </Wrap>
    </section>
  );
